export const RUN_DATA: CombinatorialComplexityConfig = {
    ...
    <>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-center bg-secondary/60 p-4 rounded-md">
          <code className="text-2xl font-mono text-secondary">
  ...
  worldsoul: (
    <>
      ...
      <div className="space-y-4">
        <p className="text-lg">
          When randomizing the order of Worldsoul, the number of possible unique
          permutations in which we can obtain fragments is given by:
        </p>
        <div className="flex items-center justify-center bg-secondary/60 p-4 rounded-md">
          <code className="text-2xl font-mono text-secondary">
  ...
  allstagstations: (
    <>
      ...
      <div className="space-y-4">
        <p className="text-lg">
          When randomizing the order of obtain all Stag Stations, the number of
  ...
  allmaskshards: (
    <>
      ...
      <div className="space-y-4">
        <p className="text-lg">
          When randomizing the order of obtaining all 16 Mask Shards, the number
  ...
  allcharmnotches: (
    <>
      ...
      <div className="space-y-4">
        <p className="text-lg">
          When randomizing the order of obtaining All Charm Notches, the number
          of possible unique permutations is given by:
        </p>
        <div className="flex items-center justify-center bg-secondary/60 p-4 rounded-md">
          <code className="text-2xl font-mono text-white">
        ...
        <div className="text-lg">
          ...
          <ul style={{ listStyle: 'disc', listStylePosition: 'inside' }}>
            <li>
              <span className="font-mono font-extrabold">Salubra Notch 1</span>,{' '}
              <span className="font-mono font-extrabold">Salubra Notch 2</span>,{' '}
              <span className="font-mono font-extrabold">Salubra Notch 3</span>{' '}
              and{' '}
              <span className="font-mono font-extrabold">Salubra Notch 4</span>{' '}
              must be obtained in the exact order{' '}
              <span className="font-mono font-extrabold">
            ...
            <li>
              ...
              <span className="font-mono font-extrabold">Grimmchild Lvl 2</span>{' '}
              and <span className="font-mono font-extrabold">Grimm Notch</span>{' '}
              must be obtained in the exact order{' '}
              <span className="font-mono font-extrabold">
                Grimmchild → Grimmchild Lvl 2 → Grimm Notch
              </span>
              . <span className="font-mono font-extrabold">Grimmchild</span> is
              added to make the race more interesting.
            </li>
          </ul>
        </div>
        <p className="text-lg">
